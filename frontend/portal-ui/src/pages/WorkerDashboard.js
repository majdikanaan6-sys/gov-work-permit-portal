  ...
  switch (status) {
      ...
      return [
        {
          id: 0,
          message:
            "Your entry permit application has been submitted by your sponsor. Application will be reviewed in due time.",
          type: "info",
        },
      ];
    ...
    case "under_review":
      return [
        {
          id: 3,
          message: "Your entry permit application is under review. Please wait for approval.",
          type: "info",
        },
      ];
